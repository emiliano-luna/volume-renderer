 ...
 */
void MinimalTutorial::errorFunction(void* userPtr, enum RTCError error, const char* str)
{
  printf("error %d: %s\n", error, str);
}
 ...
 */
RTCDevice MinimalTutorial::initializeDevice()
{
 ...
 */
RTCScene MinimalTutorial::initializeScene(RTCDevice device)
{
 ...
 * (dx, dy, dz).
 */
void MinimalTutorial::castRay(RTCScene scene,
